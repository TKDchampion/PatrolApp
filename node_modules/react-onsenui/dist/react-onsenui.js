/*! react-onsenui v1.2.0 - Tue Mar 14 2017 15:28:32 GMT+0900 (JST) */
...
var BaseDialog = function (_React$Component) {
  ...
  createClass(BaseDialog, [{
    ...
    value: function renderPortal(props, isShown) {
      ...
      ReactDOM__default.unstable_renderSubtreeIntoContainer(this, React.createElement(DomNodeName, newProps), this.node, this._update.bind(this, isShown, onDeviceBackButton));
    }
  }, {
    key: 'render',
...
var Input = function (_BasicComponent) {
  ...
  function Input() {
    ...
    var _this = possibleConstructorReturn(this, (_ref = Input.__proto__ || Object.getPrototypeOf(Input)).call.apply(_ref, [this].concat(args)));
...
var EVENT_TYPES$2 = ['change', 'input'];
...
var Select = function (_BasicComponent) {
  ...
  createClass(Select, [{
    ...
    value: function componentDidMount() {
      ...
      EVENT_TYPES$2.forEach(function (eventType) {
        node.addEventListener(eventType, _this2.onChange);
      });
    }
  }, {
